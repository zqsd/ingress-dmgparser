...
import {getDmgRows, parseAgent, parseDamage, parseMainAgent, parseStatus, parsePortal, parseLinkedPortal, parseMap} from '../dmgReportHelpers';
...
test('getDmgRows', () => {
    const body = html('<table width="750px"><tbody><tr><td><table width="700px"><tbody><tr></tr><tr></tr><tr></tr></tbody></table></td></tr></tbody></table>');
    assert.equal(getDmgRows(body).length, 3);
});
